        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="col-span-12 xl:col-span-4 md:col-span-6 admin-only">
                    <a href="/fardar_it/dist/users/users.php" class="card-link">
                        <div class="card">
                            <div class="card-header flex items-center justify-between !pb-0 !border-b-0">
                                <h5>Total Users</h5>
                ...
                <!-- Total Customers -->
                <div class="col-span-12 xl:col-span-4 md:col-span-6">
                    <a href="/fardar_it/dist/customers/customer_list.php" class="card-link">
                        <div class="card">
                            <div class="card-header flex items-center justify-between !pb-0 !border-b-0">
                                <h5>Total Customers
                                    <?php if (!$rbac->isAdmin()): ?>
                ...
                <div class="col-span-12 xl:col-span-4 md:col-span-6">
                    <a href="/fardar_it/dist/products/product_list.php" class="card-link">
                        <div class="card">
                            <div class="card-header flex items-center justify-between !pb-0 !border-b-0">
